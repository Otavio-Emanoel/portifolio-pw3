    ...
    >
      <div className="container mx-auto px-6 lg:px-8 flex flex-col-reverse lg:flex-row items-center gap-10">
        ...
        >
          ...
          >
            Olá, eu sou <span className="text-indigo-600 dark:text-indigo-400">{name}</span>
          </h1>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <a
              href="#contact"
              className="inline-flex items-center justify-center rounded-md border border-slate-200 px-5 py-3 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800"
            >
              Contato
            </a>
          </div>
        ...
        >
          <div className="relative">
            <div className="w-[260px] h-[260px] sm:w-[320px] sm:h-[320px] rounded-xl overflow-hidden bg-gradient-to-br from-indigo-100 to-indigo-50 dark:from-indigo-900/30 dark:to-indigo-800/30 shadow-lg transform transition-transform hover:scale-[1.02]">
              {imageSrc ? (
                // If using Next.js replace with <Image />
            ...
            {/* Accent circle */}
            <span className="hidden lg:block absolute -left-8 -bottom-8 w-40 h-40 bg-indigo-100/70 rounded-full blur-2xl dark:bg-indigo-800/40" />
          </div>
        </div>
      </div>
    </section>
